...
global.channelLink = "https://whatsapp.com/channel/0029VavP4nX0G0XggHzhVg0R";
global.ytch = "LordReddragon";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363374872240664@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363374872240664@newsletter';
